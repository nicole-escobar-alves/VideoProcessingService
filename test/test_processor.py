...
class TestExtractFramesToZip(unittest.TestCase):
    ...
    def test_extract_frames_success(
        ...
        mock_zip_write.assert_any_call(os.path.join(frames_dir, "frame_0000.jpg"), arcname="frame_0000.jpg")
        mock_zip_write.assert_any_call(os.path.join(frames_dir, "frame_0010.jpg"), arcname="frame_0010.jpg")
        mock_zip_write.assert_any_call(os.path.join(frames_dir, "frame_0020.jpg"), arcname="frame_0020.jpg")
        self.assertEqual(mock_zip_write.call_count, 3)
